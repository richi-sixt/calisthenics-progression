...
import type { Workout, PaginatedResponse, UserProfileResponse, PaginationMeta } from "@/types";
...
export function useFollow() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, username) => qc.invalidateQueries({ queryKey: ["user", username] }),
  });
}
