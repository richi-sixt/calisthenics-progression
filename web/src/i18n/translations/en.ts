const en = {
  ...
  "statistics.exercisePicker.label": "Exercise",
  "statistics.exercisePicker.placeholder": "Select an exercise",
  "statistics.metric.best": "Best",
  "statistics.metric.total": "Total",
  "statistics.progressionFilter.label": "Progression",
  "statistics.progressionFilter.all": "All Progressions",
  "statistics.categoryFilter.label": "Category",
  "statistics.categoryFilter.all": "All Categories",
  "statistics.granularity.week": "Week",
  "statistics.granularity.month": "Month",
  "statistics.rangeFrom": "From",
  "statistics.rangeTo": "To",
  "statistics.progression.title": "Exercise Progression",
  "statistics.progression.empty": "No exercise selected",
  "statistics.progression.emptyDescription": "Pick an exercise above to see its progression over time.",
  "statistics.progression.noData": "No logged sets in this range",
  "statistics.frequency.title": "Training Frequency & Volume",
  "statistics.frequency.sessions": "Sessions",
  "statistics.frequency.volumeReps": "Total Reps",
  "statistics.frequency.volumeDuration": "Total Duration (s)",
  "statistics.frequency.noData": "No workouts logged in this range",
