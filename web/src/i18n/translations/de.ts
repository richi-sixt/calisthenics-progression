...
const de: Record<keyof typeof en, string> = {
  ...
  "statistics.exercisePicker.label": "Übung",
  "statistics.exercisePicker.placeholder": "Übung auswählen",
  "statistics.metric.best": "Bestwert",
  "statistics.metric.total": "Gesamt",
  "statistics.progressionFilter.label": "Progression",
  "statistics.progressionFilter.all": "Alle Progressionen",
  "statistics.categoryFilter.label": "Kategorie",
  "statistics.categoryFilter.all": "Alle Kategorien",
  "statistics.granularity.week": "Woche",
  "statistics.granularity.month": "Monat",
  "statistics.rangeFrom": "Von",
  "statistics.rangeTo": "Bis",
  "statistics.progression.title": "Übungsfortschritt",
  "statistics.progression.empty": "Keine Übung ausgewählt",
  "statistics.progression.emptyDescription": "Wähle oben eine Übung aus, um ihren Fortschritt über die Zeit zu sehen.",
  "statistics.progression.noData": "Keine erfassten Sätze in diesem Zeitraum",
  "statistics.frequency.title": "Trainingshäufigkeit & Volumen",
  "statistics.frequency.sessions": "Einheiten",
  "statistics.frequency.volumeReps": "Wiederholungen gesamt",
  "statistics.frequency.volumeDuration": "Dauer gesamt (s)",
  "statistics.frequency.noData": "Keine Workouts in diesem Zeitraum erfasst",
